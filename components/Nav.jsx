  ...
  return (
    ...
    >
      <div className="max-w-[1500px] mx-auto px-6 lg:px-12 flex items-center justify-between">
        <Link href="/" data-testid="nav-logo-link" className="flex items-center gap-3 group">
          ...
          {links.map((l) => {
            ...
            return (
              <Link
                ...
                className={`font-display text-[10.5px] tracking-[0.28em] uppercase transition-colors ${
            ...
            {links.map((l) => {
              ...
              return (
                <Link
                  ...
                  className={`font-heading text-3xl tracking-tight ${isActive ? "text-[#C9973A]" : "text-[#F9F9F7]"}`}
                >
                  {l.label}
                </Link>
              );
