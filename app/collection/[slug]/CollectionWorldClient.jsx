...
// Replaces React Router's dynamic routing logic by just accepting props Next.js style
export default function CollectionWorldClient({ slug }) {
  const [activeIdx, setActiveIdx] = useState(0);

  const data = COLLECTIONS.find(c => c.slug === slug);
  ...
  return (
    ...
    >
      ...
      <section className="relative z-10 px-6 lg:px-12 max-w-[1500px] mx-auto">
        <Reveal>
          <Link href="/" data-testid="back-home-link" className="inline-flex items-center gap-2 font-display text-[10px] tracking-[0.3em] uppercase text-[#A3A3A3] hover:text-[#C9973A] transition mb-12">
          ...
          <Reveal delay={150} className="lg:col-span-5">
            ...
            >
              ...
              <div className="flex flex-wrap gap-4 mt-10">
                ...
                <Link href="/reserve" data-testid={`artifact-reserve-${active.id}`} className="btn-ghost-gold">
                  Reserve A Viewing
                </Link>
              </div>
            </motion.div>
      ...
      <section className="relative z-10 px-6 lg:px-12 max-w-[1500px] mx-auto pt-12 border-t border-[#C9973A]/15">
        <Reveal>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <Link href="/bridal-journey" data-testid="continue-bridal" className="group">
            ...
            <Link href="/reserve" data-testid="continue-reserve" className="group">
              <div className="relative p-10 border border-[#C9973A]/20 hover:border-[#C9973A] transition-colors h-full">
