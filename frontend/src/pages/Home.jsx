...
import { listCollections, whatsappUrl, SBJ_ADDRESS } from "@/lib/api";

const HeroScene = lazy(() => import("@/components/3d/HeroScene"));
const TempleScene = lazy(() => import("@/components/3d/TempleScene"));
      ...
      <section className="relative min-h-screen flex items-center pt-32 pb-20 overflow-hidden">
        ...
        <div className="relative z-10 max-w-[1500px] mx-auto px-6 lg:px-12 grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          <div className="lg:col-span-7">
            ...
            >
              <Link to="/bridal-journey" data-testid="hero-bridal-cta" className="btn-gold">
                Begin Your Bridal Journey
              </Link>
              <Link to="/reserve" data-testid="hero-reserve-cta" className="btn-ghost-gold">
        ...
        <div className="max-w-[1500px] mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-8">
            {collections.map((c, i) => (
              ...
              >
                <Link to={`/collection/${c.slug}`} data-testid={`world-card-${c.slug}`} className="block relative overflow-hidden">
      ...
      >
        ...
        <div className="relative z-10 max-w-[1300px] mx-auto text-center">
          <Reveal>
            ...
            <Link to="/bridal-journey" data-testid="bridal-cta-2" className="btn-gold mt-12 inline-block">
              Begin Your Bridal Journey
            </Link>
          </Reveal>
        </div>
        ...
        <div className="max-w-[1500px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <Reveal className="lg:col-span-6">
            ...
            <div className="flex flex-wrap gap-4 mt-10">
              ...
              <Link to="/reserve" data-testid="concierge-reserve-link" className="btn-ghost-gold">
                Reserve A Private Viewing
              </Link>
            </div>
          </Reveal>
      ...
      <section className="relative py-32 px-6 lg:px-12" data-testid="showroom-section"
        ...
        <div className="max-w-[1500px] mx-auto">
          ...
          <Reveal delay={150} className="text-center">
            ...
            <Link to="/showroom" data-testid="visit-showroom-link" className="btn-ghost-gold inline-block">
              Plan Your Visit
            </Link>
          </Reveal>
        </div>
