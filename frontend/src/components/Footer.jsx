      ...
      <div className="max-w-[1500px] mx-auto px-6 lg:px-12 py-20 grid grid-cols-1 md:grid-cols-12 gap-10">
        ...
        <div className="md:col-span-3">
          ...
          <ul className="space-y-3 font-body text-sm">
            <li><Link to="/collection/temple" className="text-[#F9F9F7]/70 hover:text-[#C9973A] transition">Temple of Heritage</Link></li>
            <li><Link to="/collection/emerald" className="text-[#F9F9F7]/70 hover:text-[#C9973A] transition">The Emerald Chamber</Link></li>
            <li><Link to="/collection/bridal" className="text-[#F9F9F7]/70 hover:text-[#C9973A] transition">Bridal Constellation</Link></li>
            <li><Link to="/collection/pearls" className="text-[#F9F9F7]/70 hover:text-[#C9973A] transition">House of Pearls</Link></li>
            <li><Link to="/collection/modern" className="text-[#F9F9F7]/70 hover:text-[#C9973A] transition">The Modern Aura</Link></li>
          </ul>
        </div>
        ...
        <div className="md:col-span-4">
          ...
          <div className="flex gap-3 mt-8">
            <Link to="/reserve" data-testid="footer-reserve" className="btn-ghost-gold text-[10px] py-3 px-5">Reserve Viewing</Link>
            <Link to="/bridal-journey" data-testid="footer-bridal" className="btn-ghost-gold text-[10px] py-3 px-5">Bridal Journey</Link>
          </div>
        </div>
      </div>
